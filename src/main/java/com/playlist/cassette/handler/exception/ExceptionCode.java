...
public enum ExceptionCode {
    ...
    NUMBER_OF_TAPE_PER_MEMBER_EXCEEDS_1(HttpStatus.BAD_REQUEST, "NUMBER_OF_TAPE_PER_MEMBER_EXCEEDS_1", "멤버당 허용되는 테이프의 개수가 초과되었습니다."),
    NUMBER_OF_TRACKS_PER_TAPE_EXCEEDS_12(HttpStatus.BAD_REQUEST, "NUMBER_OF_TRACKS_PER_TAPE_EXCEEDS_12", "테이프당 허용되는 트랙의 개수가 초과되었습니다."),
